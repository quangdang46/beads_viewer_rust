...
fn raw_command_docs() -> Vec<(&'static str, CommandDoc)> {
    vec![
        ...
        ("robot-capabilities", c("--robot-capabilities", "Machine-readable command manifest for agent command discovery.", &["tool", "version", "contract_version", "commands", "environment_variables", "exit_codes"], &[], false, false, false, false, false)),
